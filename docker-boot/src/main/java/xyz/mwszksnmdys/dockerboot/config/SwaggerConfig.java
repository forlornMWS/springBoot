package xyz.mwszksnmdys.dockerboot.config;
...
public class SwaggerConfig
{
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .enable(enabled)
                .select()
                .apis(RequestHandlerSelectors.basePackage("xyz.mwszksnmdys.dockerboot")) //你自己的package
    ...
    public ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("mws"+"\t"+new SimpleDateFormat("yyyy-MM-dd").format(new Date()))
                .description("docker-compose")
                .version("1.0")
                .termsOfServiceUrl("https://mwszksnmdys.xyz/")
                .build();
    }
